 ...
 */
	struct {
		...
		unsigned role:2 ;   /* 3/4	 primary/secondary/unknown */					/* Local role */
		unsigned peer:2 ;   /* 3/4	 primary/secondary/unknown */					/* 接続先role */
		unsigned conn:5 ;   /* 17/32	 cstates */									/* ネットワーク接続状態 */
		unsigned disk:4 ;   /* 8/16	 from D_DISKLESS to D_UP_TO_DATE */				/* Local Disk状態 */
		unsigned pdsk:4 ;   /* 8/16	 from D_DISKLESS to D_UP_TO_DATE */				/* 接続先 Disk状態 */
		...
		unsigned pdsk:4 ;   /* 8/16	 from D_DISKLESS to D_UP_TO_DATE */				/* 接続先 Disk状態 */
		unsigned disk:4 ;   /* 8/16	 from D_DISKLESS to D_UP_TO_DATE */				/* Loacl Disk状態 */
		unsigned conn:5 ;   /* 17/32	 cstates */									/* ネットワーク接続状態 */
		unsigned peer:2 ;   /* 3/4	 primary/secondary/unknown */					/* 接続先role */
		unsigned role:2 ;   /* 3/4	 primary/secondary/unknown */					/* Local role */
#else
